/**
 * Update Week 1 formatting with proper line breaks
 */
...
async function main() {
  console.log('🔧 Updating Week 1 formatting...\n')
  ...
  // Update with properly formatted content (double newlines for Markdown paragraphs)
...
- Write 300 words: "How I Structured Data for ML: Features, Labels, and Why They Matter"`
  ...
  console.log('✅ Week 1 formatting updated!')
  console.log('   - Added proper line breaks')
  console.log('   - Fixed paragraph spacing')
  console.log('   - Improved bullet point formatting')
