/**
 * Update Week 1 with better spacing and visual separation
 */
...
async function main() {
  console.log('🔧 Updating Week 1 spacing...\n')
  ...
  // Update with better spacing and clear day sections
...
## Practical Experiments (Wednesday-Saturday)
...
CSV with real data, Python script showing EDA, write 300 words: "How I Structured Data for ML: Features, Labels, and Why They Matter"`
  ...
  console.log('✅ Week 1 spacing updated!')
  console.log('   - Added ## headers for day sections')
  console.log('   - More line breaks between items')
  console.log('   - Clear visual separation with ---')
